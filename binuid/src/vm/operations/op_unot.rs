    ...
    pub fn op_unot(&mut self) {
        match self.pop_instructions(3) {
            Some(data) => {
                ...
                match data_type {
                    DataType::None => {},
                    DataType::ByteType => {crate::OpUnary!(self, u8, size, !);},
                    DataType::BoolType => {crate::OpUnary!(self, u8, size, !);},
                    DataType::CharType => {},
                    DataType::F32Type => {},
                    DataType::F64Type => {},
                    DataType::FnType => {},
                    ...
                    DataType::U8Type => {crate::OpUnary!(self, u8, size, !);},
                    DataType::U16Type => {crate::OpUnary!(self, u16, size, !);},
                    DataType::U32Type => {crate::OpUnary!(self, u32, size, !);},
                    DataType::U64Type => {crate::OpUnary!(self, u64, size, !);},
                    DataType::U128Type => {crate::OpUnary!(self, u128, size, !);},
                    DataType::RefType => {},
                    DataType::StringType => {},
                    DataType::UnitType => {},
                    DataType::TupleType => {},
