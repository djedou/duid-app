...
use crate::core::html::attributes::{AttributeValue, Attribute, attr};
use wasm_bindgen::JsCast;

#[cfg(web_sys_unstable_apis)]
pub use web_sys::ClipboardEvent;
pub use web_sys::{
    AnimationEvent, HashChangeEvent, KeyboardEvent, MouseEvent, TransitionEvent, Event as WebEvent
};
use web_sys::{
...
pub type Listener<MSG> = listener::Listener<Event, MSG>;
    ...
    MSG: 'static
{
    on("scroll", move |event: Event| {
        ...
        if let Some(element) = target.dyn_ref::<web_sys::Element>() {
            ...
            let window = crate::core::util::window();
            let scroll_top =
    ...
    ( $(
        ...
        $(
            doc_comment::doc_comment!{
                ...
                $(#[$attr])*
                #[inline]
                pub fn $name<CB, MSG>(cb: CB) -> crate::core::html::attributes::Attribute<MSG>
